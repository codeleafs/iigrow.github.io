...
CommonJS
    ...
    */
    ...
    // 代码中的所有require模块都会被直接打包，而require.ensure不会被打包进去，只有执行到require.ensure时才会加载。
    module.exports=function(){
        require('modulea'); //modulea会被打包到当前chunk中
        require.ensure('moduleb'); // moduleb只有new该chunk时才会被加载
    }
...
AMD
    ...
    // require loads and evaluate the modules
